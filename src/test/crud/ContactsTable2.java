...
public class ContactsTable2 {
    ...
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(CONNECTION_STRING);
            ...
            stmt.execute("CREATE TABLE IF NOT EXISTS " + TABLE_CONTACTS + " ("
                    ...
                    + COLUMN_EMAIL + " TEXT)");
            insertContacts(stmt, "mike", 12345, "mike@mail.com");
            insertContacts(stmt, "nike", 23456, "nike@mail.com");
            insertContacts(stmt, "tolstjak", 34567, "tolstjak@mail.com");
    ...
    public static void insertContacts(Statement stmt, String name, int phone, String email) throws SQLException {
